...
pair<num, num> getfutprice(const date& monitorDate) {
    ...
    cout<< "Fut Price " << futmid << " with error " << errmid << ";CTDidx="<< CTDi <<" date="<< monitorDate <<  endl;
    return make_pair(num(basket[int(CTDi)].getMaturityDate())/365+2024, elapsed_time);
